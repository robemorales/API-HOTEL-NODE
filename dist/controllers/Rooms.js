...
exports.updateRoom = exports.saveRoom = exports.getRooms = exports.getRoomCount = exports.getRoom = exports.deleteRoom = void 0;
...
var getRooms = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            _context.next = 5;
            return connections.query('SELECT * from habitacion');
  ...
  return function getRooms(_x, _x2) {
...
var getRoom = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            _context2.next = 5;
            return connections.query('SELECT * from habitacion where id = ?', [req.params.id]);
  ...
  return function getRoom(_x3, _x4) {
...
var getRoomCount = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            _context3.next = 5;
            return connections.query('SELECT count(*) from habitacion');
  ...
  return function getRoomCount(_x5, _x6) {
...
var saveRoom = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            _context4.next = 5;
            return connections.query("INSERT INTO habitacion(title, description, cat, price, stock, notAvailablestart, notAvailableend) VALUES(?,?,?,?,?,?,?)", [req.body.title, req.body.description, req.body.cat, req.body.price, req.body.stock, req.body.notAvailablestart, req.body.notAvailableend]);
  ...
  return function saveRoom(_x7, _x8) {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 2:
            ...
            _context5.next = 5;
            return connections.query('DELETE from habitacion where id = ?', [req.params.id]);
...
var updateRoom = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 2:
            ...
            _context6.next = 5;
            return connections.query('UPDATE habitacion SET ? where id = ?', [req.body, req.params.id]);
  ...
  return function updateRoom(_x11, _x12) {
